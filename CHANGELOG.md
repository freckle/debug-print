## [_Unreleased_](https://github.com/freckle/debug-print/compare/v0.2.2.0...main)

## [v0.2.2.0](https://github.com/freckle/debug-print/compare/v0.2.1.0...v0.2.2.0)

Add `ToDebugPrintValue` and `ToDebugPrintRecord` instances for `Void`
